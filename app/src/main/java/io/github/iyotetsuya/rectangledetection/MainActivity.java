...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        subject.concatMap(cameraData ->
                ...
                .concatMap(matData -> OpenCVHelper.resize(matData, 353, 206))
                .map(matData -> {
        ...
        Button captureButton = (Button) findViewById(R.id.capture_id);
        captureButton.setOnClickListener(this);
    }

    private Observable<MatData> detectRect(MatData mataData) {
        Log.v(TAG, "Div MatData"+mataData);
